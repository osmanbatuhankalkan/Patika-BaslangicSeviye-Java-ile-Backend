public class Main {
    public static void main(String[] args) {
        ...
        Ogrenci s1 = new Ogrenci("Batuhan Batuhanoğlu", "112", 141, mat, fizik, kimya);
        s1.addSinavNotlari(70,55,80);
        s1.gectiMi();

        Ogrenci s2 = new Ogrenci("Ayse AyseKızı", "1453", 333, mat, fizik, kimya);
        s2.addSinavNotlari(95,90,100);
        s2.gectiMi();

        Ogrenci s3 = new Ogrenci("Osman Osmanoğlu", "1190", 213, mat, fizik, kimya);
